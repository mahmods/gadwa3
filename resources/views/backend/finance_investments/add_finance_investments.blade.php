        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('finance_investments.add_finance_investments')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddFinanceInvestment')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="personal_investment" value="{{old('personal_investment')}}" type="text" class="form-control" placeholder="{{trans('finance_investments.personal_investment')}}" >
                            ...
                            <div class="form-group">
                                ...
                                <input name="loan" value="{{old('loan')}}" type="text" class="form-control" placeholder="{{trans('finance_investments.loan')}}" >
                                @if($errors->has('loan'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="other" value="{{old('other')}}" type="text" class="form-control" placeholder="{{trans('finance_investments.other')}}" >
                                @if($errors->has('other'))
                        ...
                        <div class="form-actions">
                            <div class="btn-set pull-left">
                                ...
                                <a class="btn blue" href="{{route('getAllFinanceInvestments')}}">{{trans('backend.cancel')}}</a>
                            </div>
                        </div>
                    </form>
                    <!-- END FORM-->
