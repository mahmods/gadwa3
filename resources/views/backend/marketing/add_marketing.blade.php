        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('marketing.add_marketing')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddMarketing')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" value="{{old('title')}}" type="text" class="form-control" placeholder="{{trans('marketing.title')}}" >
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                {{--<input name="email" value="{{old('email')}}" type="text" class="form-control" placeholder="{{trans('studies.email')}}" >--}}
                                <textarea name="description" class="form-control" placeholder="{{trans('marketing.description')}}">{{old('description')}}</textarea>
