        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('content.update_content')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('updateContentById',['contentId'=>$content->id])}}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group">
                                ...
                                <select onchange="yesnoCheck(this);"  name="content_type" id="single" class="form-control select2">
                                    <option value="{{$content->content_type}}">{{trans('content.'.$content->content_type)}}</option>
                            ...
                            <div id="hint_order" class="form-group">
                                ...
                                <input name="hint_order" value="{{$content->hint_order}}" type="text" class="form-control"
                            ...
                            <div id="step_name" class="form-group">
                                ...
                                <input name="step_name" value="{{$content->step_name}}" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <input name="title" value="{{$content->title}}" type="text" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control"
                                          placeholder="{{trans('content.description')}}">{{$content->description}}</textarea>
                            ...
                            <div id="content_image" class="form-group">
                                ...
                                <img height="80" src="{{ASSETS}}/images/{{$content->image}}">
                                @if($errors->has('image'))
                            ...
                            <div id="video_link" class="form-group">
                                ...
                                <input type="text" value="{{$content->video}}"  name="video"  class="form-control"
