        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('raw_material.add_raw_material')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddRawMaterial')}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control"
                                          placeholder="{{trans('raw_material.description')}}">{{old('description')}}</textarea>
