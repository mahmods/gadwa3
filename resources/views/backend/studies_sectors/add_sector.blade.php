    ...
    <div class="col-md-12">
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>{{trans('studies_sector.add_sector')}}</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form method="post" action="{{route('postAddStudiesSector')}}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control"
                                      placeholder="{{trans('sector.description')}}">{{old('description')}}</textarea>
                    ...
                    <div class="form-actions">
                        <div class="btn-set pull-left">
                            ...
                            <a class="btn blue"
                               href="{{route('getAllStudiesSectors')}}">{{trans('backend.cancel')}}</a>
                        </div>
                    </div>
                </form>
                <!-- END FORM-->
