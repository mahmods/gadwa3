    ...
    <div class="col-md-12">
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>{{trans('country.update_country')}}</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form method="post" action="{{route('updateCountryById',['countryId'=>$country->id])}}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <input name="title" value="{{$country->title}}" type="text" class="form-control"
                                   placeholder="{{trans('country.title')}}">
                            @if($errors->has('title'))
                        ...
                        <div class="form-group">
                            ...
                            <input name="code" value="{{$country->code}}" type="text" class="form-control"
                                   placeholder="{{trans('country.title')}}">
                            @if($errors->has('code'))
