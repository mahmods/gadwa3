...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="{{route('getAllExpenseCategories')}}">{{trans('expense.backend_head_title')}}</a>
            </li>
    ...
    <div class="col-md-12">
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>{{trans('expense.update_expense_categories')}}</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form method="post"
                      action="{{route('updateExpenseCategoriesById',['expenseCategoryId'=>$category->id])}}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" class="form-control"
                                      placeholder="{{trans('expense.description')}}">{{$category->title}}</textarea>
                    ...
                    <div class="form-actions">
                        <div class="btn-set pull-left">
                            ...
                            <a class="btn blue"
                               href="{{route('getAllExpenseCategories')}}">{{trans('backend.cancel')}}</a>
