...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">{{trans('expense.expense_categories')}}</a>
            </li>
        </ul>
...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddExpenseCategories')}}"><i class="fa fa-level-down"></i> {{trans('expense.add_expense_categories')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('expense.all_expense_categories')}}</div>
                <div class="tools"></div>
            </div>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-outline btn-circle btn-sm purple"
                                   href="{{route('getExpenseCategoriesById',['expenseCategoryId'=>$category->id])}}">
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteExpenseCategoriesById',['expenseCategoryId'=>$category->id])}}">
                                    {{ csrf_field() }}
                                </form>
                            </td>
                        </tr>
