    ...
    <div class="col-md-12">
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>{{trans('currency.update_currency')}}</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form method="post" action="{{route('updateCurrencyById',['currencyId'=>$currency->id])}}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">{{trans('currency.symbol')}}</label>
                            <input name="symbol" value="{{$currency->symbol}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="code" value="{{$currency->code}}" type="text" class="form-control"
                                   placeholder="{{trans('currency.code')}}">
                            @if($errors->has('code'))
                        ...
                        <div class="form-group">
                            ...
                            <input name="rate" value="{{$currency->rate}}" type="text" pattern="[0-9.]{0,1000}"
                                   class="form-control" placeholder="{{trans('currency.rate')}}">
                            @if($errors->has('rate'))
