...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="">{{trans('currency.currencies')}}</a>
            </li>
        </ul>
...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddCurrency')}}"><i class="fa fa-level-down"></i> {{trans('currency.add_currency')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('currency.all_currencies')}}</div>
                <div class="tools"></div>
            </div>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-outline btn-circle btn-sm purple"
                                   href="{{route('getCurrencyById',['currencyId'=>$currency->id])}}">
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteCurrencyById',['currencyId'=>$currency->id])}}">
                                    {{ csrf_field() }}
                                </form>
                            </td>
                        </tr>
