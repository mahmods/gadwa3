...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddSector')}}"><i class="fa fa-level-down"></i> {{trans('sector.add_sector')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('sector.all_sectors')}}</div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tr>
                        <th>#</th>
                        <th>{{trans('sector.title')}}</th>
                        <th>{{trans('sector.description')}}</th>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-outline btn-circle btn-sm purple"
                                   href="{{route('getSectorById',['sectorId'=>$sector->id])}}">
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteSectorById',['sectorId'=>$sector->id])}}">
                                    {{ csrf_field() }}
                                </form>
                            </td>
                        </tr>
