        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddUnit')}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label">{{trans('unit.title')}}</label>
                                <input name="title" value="{{old('title')}}" type="text" class="form-control" placeholder="{{trans('studies.title')}}" >
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="{{trans('unit.description')}}">{{old('description')}}</textarea>
