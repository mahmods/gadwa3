...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddCity',['country_id'=>$country_id])}}"><i class="fa fa-level-down"></i> {{trans('city.add_city')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('city.all_cities')}}</div>
                <div class="tools"></div>
            </div>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-outline btn-circle btn-sm purple"
                                   href="{{route('getCityById',['cityId'=>$city->id,'country_id'=>$city->country_id])}}">
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteCityById',['cityId'=>$city->id,'country_id'=>$city->country_id])}}">
                                    {{ csrf_field() }}
