...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">{{trans('competitor.competitors')}}</a>
            </li>
...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddCompetitor')}}"><i class="fa fa-level-down"></i> {{trans('competitor.add_competitor')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('competitor.all_competitors')}}</div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tr>
                        ...
                        <th>{{trans('competitor.study')}}</th>
                        <th>{{trans('competitor.title')}}</th>
                        <th>{{trans('competitor.description')}}</th>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteCompetitorById',['competitorId'=>$competitor->id])}}">
                                    {{ csrf_field() }}
                                </form>
                            </td>
                        </tr>
