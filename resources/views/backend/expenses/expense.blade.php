    ...
    <div class="col-md-12">
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-gift"></i>{{trans('expense.update_expense')}}</div>
                <div class="tools">
            ...
            <div class="portlet-body form">
                <!-- BEGIN FORM-->
                <form method="post" action="{{route('updateExpenseById',['expense_id'=>$expense->id])}}">
                    {{ csrf_field() }}
                    <div class="form-body">
                        <div class="form-group">
                            <label class="control-label">{{trans('expense.title')}}</label>
                            <input name="title" value="{{$expense->title}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="item" value="{{$expense->item}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="type" value="{{$expense->type}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="location" value="{{$expense->location}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="value" value="{{$expense->value}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="space" value="{{$expense->space}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <input name="count" value="{{$expense->count}}" type="text" class="form-control"
                        ...
                        <div class="form-group">
                            ...
                            <select name="category_id" id="single" class="form-control select2">
                                <option value="{{$expense->category_id}}">
                                    {!! \App\Repositories\ExpenseCategoriesRepository::getAllExpenseCategoriesView()->where('id',$expense->category_id)->first()->title !!}
                                </option>
                        ...
                        <div class="form-group">
                            ...
                            <select name="study_id" id="single" class="form-control select2">
                                <option value="{{$expense->study_id}}">
                                    {!! \App\Repositories\StudyRepository::getAllStudiesView()->where('id',$expense->study_id)->first()->title !!}
                                </option>
