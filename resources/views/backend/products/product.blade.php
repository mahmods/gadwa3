        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('product.update_product')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('updateProductById',['productId'=>$product->id])}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <select id="study_id" name="study_id" id="single" class="form-control select2">
                                    ...
                                    @foreach(\App\Repositories\StudyRepository::getAllStudiesView() as $study)
                                        <option value="{{$study->id}}" @if($product->study_id==$study->id) selected @endif>{{$study->title}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <input name="production" value="{{$product->production}}" type="number"
                            ...
                            <div class="form-group">
                                ...
                                <input name="sales" value="{{$product->sales}}" type="number" class="form-control"
                            ...
                            <div class="form-group">
                                ...
                                <select id="unit_id" name="unit_id" id="single" class="form-control select2">
                                    ...
                                    @foreach(\App\Repositories\UnitRepository::getAllUnitesView() as $unit)
                                        <option value="{{$unit->id}}" @if($product->unit_id==$unit->id) selected @endif>{{$unit->title}}</option>
                                    @endforeach
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control"
                                          placeholder="{{trans('marketing.description')}}">{{$product->description}}</textarea>
