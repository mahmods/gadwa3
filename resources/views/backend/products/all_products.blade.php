...
@section('breadcrumb')
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <a href="#">{{trans('product.products')}}</a>
            </li>
...
<div class="row">
    <div class="col-md-12">
        <div class="btn-group">
            <a class="btn green" href="{{route('getAddProduct')}}"><i class="fa fa-level-down"></i> {{trans('product.add_product')}}
            </a>
        </div>
        <br clear="all">
        <br clear="all">
        ...
        <div class="portlet box gadwa">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-globe"></i>{{trans('product.all_products')}}</div>
                <div class="tools"></div>
            </div>
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tr>
                        ...
                        <th>{{trans('product.study')}}</th>
                        <th>{{trans('product.title')}}</th>
                        <th>{{trans('product.price')}}</th>
                        <th>{{trans('product.production')}}</th>
                        <th>{{trans('product.sales')}}</th>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>
                                <a class="btn btn-outline btn-circle btn-sm purple"
                                   href="{{route('getProductById',['productId'=>$product->id])}}">
                                ...
                                <form id="form_delete" class="form-delete-c" method="post"
                                      ...
                                      action="{{route('deleteProductById',['productId'=>$product->id])}}">
                                    {{ csrf_field() }}
                                </form>
                            </td>
                        </tr>
