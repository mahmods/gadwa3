        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('assets.add_asset')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('postAddAsset')}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label">{{trans('assets.title')}}</label>
                                <input name="title" value="{{old('title')}}" type="text" class="form-control" placeholder="{{trans('assets.title')}}" >
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control" placeholder="{{trans('assets.description')}}">{{old('description')}}</textarea>
                            ...
                            <div class="form-group">
                                ...
                                <input name="value" value="{{old('value')}}" type="text" class="form-control" placeholder="{{trans('assets.value')}}" >
                                @if($errors->has('title'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="space" value="{{old('space')}}" type="text" class="form-control" placeholder="{{trans('assets.space')}}" >
                                @if($errors->has('space'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="count" value="{{old('count')}}" type="text" class="form-control" placeholder="{{trans('assets.count')}}" >
                                @if($errors->has('count'))
                            ...
                            <div class="form-group">
                                ...
                                <select name="deprecation_id" id="single" class="form-control select2">
                                    <option value="">{{trans('assets.deprecation_type')}}</option>
