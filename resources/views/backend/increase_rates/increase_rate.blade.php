        ...
        <div class="col-md-12">
            <div class="portlet box gadwa">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('update_rate.add_increase_rate')}}</div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <form method="post" action="{{route('updateIncreaseRateById',['increaseRateId'=>$increase_rate->id])}}">
                        {{ csrf_field() }}
                        <div class="form-body">
                            <div class="form-group">
                                <label class="control-label">{{trans('increase_rate.years')}}</label>
                                <input name="years" value="{{$increase_rate->years}}" type="number" class="form-control" placeholder="{{trans('increase_rate.years')}}" >
                                @if($errors->has('years'))
                            ...
                            <div class="form-group">
                                ...
                                <input name="percentage" value="{{$increase_rate->percentage}}" type="text" class="form-control" placeholder="{{trans('increase_rate.percentage')}}" >
                            ...
                            <div class="form-group">
                                ...
                                <select name="study_id" id="single" class="form-control select2">
                                    <option value="{{$increase_rate->study_id}}">
                                        {!! \App\Repositories\StudyRepository::getAllStudiesView()->where('id',$increase_rate->study_id)->first()->title !!}
                                    </option>
