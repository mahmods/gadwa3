...
<head>
    <meta charset="utf-8" />
    <title>Metronic Admin RTL Theme #4 | User Login 5</title>
        ...
        <div class="col-md-6 login-container bs-reset mt-login-5-bsfix">
            <div class="login-content">
                ...
                <form class="login-form" method="POST" action="{{ route('login') }}">
                    ...
                    <div class="row">
                        <div class="col-xs-6{{ (isset($errors) && $errors->has('email')) ? ' has-error' : '' }}">
                            <input id="email" class="form-control form-control-solid placeholder-no-fix form-group" type="text"  placeholder="E-mail" name="email" value="{{ old('email') }}" required/>
                            @if ($errors->has('email'))
                        ...
                        <div class="col-xs-6{{ $errors->has('password') ? ' has-error' : '' }}">
                            <input id="password" class="form-control form-control-solid placeholder-no-fix form-group" type="password"  placeholder="Password" name="password" required/>
