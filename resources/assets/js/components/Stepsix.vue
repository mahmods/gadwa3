    ...
    <div class="container page-content">
        ...
        <div class="steps">
            <div v-bind:class="[study_status.step_one==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" :to="{ name: 'Stepone' }"><span>بيانات المشروع</span>
                </router-link>
            </div>
            <div v-bind:class="[study_status.step_two==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" to="/step-2"><span>بيانات السوق</span></router-link>
            </div>
            <div v-bind:class="[study_status.step_three==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" to="/step-3"><span>الطاقه الانتاجيه</span>
                </router-link>
            </div>
            <div v-bind:class="[study_status.step_four==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" to="/step-4"><span>رأس المال الثابت</span>
                </router-link>
            </div>
            <div v-bind:class="[study_status.step_five==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" to="/step-5"><span> تكاليف التشغيل </span>
                </router-link>
            </div>
            <div v-bind:class="[study_status.step_five==1 ? 'step-item done' : 'step-item']">
                <i></i>
                <router-link v-on:click.native="" to="/step-6"><span> الاستثمار والتمويل  </span>
                </router-link>
            </div>
    ...
    export default {
        ...
        methods: {
            createSixStep(par=true){
                ...
                window.location.href = './../study-view/' + this.studyId;
            },
             fireEvent(){
                let list1 = 0;
                let list2 = 0;
